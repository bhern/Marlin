...
#define CUSTOM_MACHINE_NAME "Ender-3 RED"
...
// #define X_PROBE_OFFSET_FROM_EXTRUDER -43; //-left of nozzle
// #define Y_PROBE_OFFSET_FROM_EXTRUDER -13; //-front of nozzle
...
// BEN Offset. Setting it to 2 I am expecting to move to the right.
// It move it the wrong direction so going -3
#define MANUAL_X_HOME_POS -3

// BEN Offset of the bed because of the stupid HMG5
// Originally i had this at -15, but i had to go to -10
// The reason is beacuse the bed wanted to go too far forward.  Not sure wich direction is wich
// down to -5
